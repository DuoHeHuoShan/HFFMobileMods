...
enum class Achievement
{
    ...
    ACH_CANDYLAND_DONUT,
    ACH_CANDYLAND_BALLS,
    ACH_TESTCHAMBER_FINISHLEVEL,
    ACH_TESTCHAMBER_CAKE,
    ACH_TESTCHAMBER_VENTS,
    ACH_TESTCHAMBER_RECYCLE
};
...
std::unordered_map<Achievement, std::string> Achievement2Str
{
        ...
        { Achievement::ACH_TESTCHAMBER_FINISHLEVEL, "ACH_TESTCHAMBER_FINISHLEVEL" },
        { Achievement::ACH_TESTCHAMBER_CAKE, "ACH_TESTCHAMBER_CAKE" },
        { Achievement::ACH_TESTCHAMBER_VENTS, "ACH_TESTCHAMBER_VENTS" },
        { Achievement::ACH_TESTCHAMBER_CAKE, "ACH_TESTCHAMBER_CAKE" }
};
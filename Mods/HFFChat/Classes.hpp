...
BNMU_BeginDefineClass(Time, "UnityEngine", Time)
...
BNMU_BeginDefineClass(NetGame, "Multiplayer", NetGame)
    ...
    BNMU_DefineField(BNM::Field<bool>, isNetStarted)
BNMU_EndDefineClass()

BNMU_BeginDefineClass(NetChat, "Multiplayer", NetChat)
    BNMU_DefineField(BNM::Field<void *>, instance)
    BNMU_DefineField(BNM::Field<bool>, visible)
    BNMU_DefineField(BNM::Field<bool>, typing)
    BNMU_DefineField(BNM::Field<float>, dismissIn)
    ...
    BNMU_DefineMethod(BNM::Method<void>, Show, -1)
